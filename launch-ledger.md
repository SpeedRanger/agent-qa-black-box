# Agent QA Black Box Launch Ledger
...
| --- | --- | ---: | --- | --- |
| Autopsy 1 | TBD | `$19` | Missing | Open |
| Autopsy 2 | TBD | `$19` | Missing | Open |
| Autopsy 3 | TBD | `$19` | Missing | Open |
| Autopsy 4 | TBD | `$19` | Missing | Open |
| Autopsy 5 | TBD | `$19` | Missing | Open |

One paid autopsy clears the `$10` target before fees only when receipt/export/
